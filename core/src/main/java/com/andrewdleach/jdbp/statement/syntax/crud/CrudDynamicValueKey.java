...
public enum CrudDynamicValueKey {
	SCHEMA_NAME("SCHEMA_NAME"), TABLE_NAME("TABLE_NAME"), COLUMN_NAME("COLUMN_NAME"), COLUMN_VALUE("COLUMN_VALUE"), CLAUSE_KEY_VALUE("CLAUSE_KEY_VALUE"), CLAUSE_VALUE("CLAUSE_VALUE"), ALLOWS_MULTIPLES("...");
