...
import jdbp.host.HostManager;
import jdbp.schema.SchemaManager;

/**
 * Utility to obtain the jdbp.driver in the classpath, check if it is compatible against the predefined list of drivers and register it with the
 * jdbp.driver manager
 * 
 * @since 12.1.2016
 * @author andrew.leach
...
public class DriverLocator {
	...
	/**
	 * Find the appropriate jdbc jdbp.driver based on property files and availability in the classpath
	 */
	...
	/**
	 * Utility method to locate the first valid JDBC jdbp.driver in the classPath
	 * 
	...
	/**
	 * Utility method to locate the requested jdbp.driver by driverName if you have more than one jdbp.driver in the classpath supporting
